...
public class CCASearchFragment extends Fragment {
    ...
    public static CCASearchFragment newInstance() {
        return new CCASearchFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayout CCASearchMenuLayout = getActivity().findViewById(R.id.CCACheckboxInnerContainer);
        for (String cca : allCCAs)
        {
            ...
            CCASearchMenuLayout.addView(ccaCheckbox);
        }
